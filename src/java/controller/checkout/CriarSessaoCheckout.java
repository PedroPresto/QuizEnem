...
public class CriarSessaoCheckout extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Stripe.apiKey = "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"; // sua chave secreta da Stripe
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setCancelUrl("https://quizenem.com.br/")
                .setCustomerEmail(email)
                .addLineItem(
                        SessionCreateParams.LineItem.builder()
                                .setPrice("price_1Rxzl6JP5pkvBk4dkvkvusVL") // Id do produto
                                .setQuantity(1L)
                                .build()
                )
                .build();
