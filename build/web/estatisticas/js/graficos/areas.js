export function criarGraficoAreas(estatisticas, chartInstance, resetarCanvas) {
    ...
    const labels = estatisticas.rankingPorArea.map(a => a.area);
    const valores = estatisticas.rankingPorArea.map(a => a.taxa);
