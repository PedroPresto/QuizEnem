...
<html>
    <head>
        ...
        <script type="module" src="${pageContext.request.contextPath}/autenticacao/fragment/autenticacao.js"></script>
        <script type="module" src="${pageContext.request.contextPath}/autenticacao/fragment/googleOAuth.js"></script>
                ...
                <section class="quick-actions" id="quick-actions">
                    ...
                    <div class="action-cards">
                        ...
                        <div class="action-card">
                            ...
                            <p>Escolha as matérias, o número de questões, ano da prova e personalize conforme sua estratégia.</p>
